	...
	<div class="row">
		...
		<div class="col-md-9">
			<div class="contact-form">
                <form action="{{route('user.update',$user->id)}}" action="" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
				  ...
				  <div class="col-sm-10">          
					<input type="password" class="form-control" id="lname" placeholder="Enter Last Name" name="password">
				  </div>
				</div>
				<div class="form-group">
                ...
                <div class="form-group">
				  ...
				  <div class="col-sm-10">
					<input type="text" class="form-control" id="email" placeholder="Enter email" name="address">
				  </div>
				</div>
                <div class="form-group">
